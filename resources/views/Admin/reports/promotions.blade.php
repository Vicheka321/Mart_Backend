...
@section('content')
    ...
    <style>
            ...
            .insight-card:nth-child(1) { animation-delay: .32s; }
            .insight-card:nth-child(2) { animation-delay: .37s; }
            .insight-card:nth-child(3) { animation-delay: .42s; }
            .insight-card:nth-child(4) { animation-delay: .47s; }
            .insight-card:nth-child(5) { animation-delay: .52s; }
            .insight-card:nth-child(6) { animation-delay: .57s; }
            .insight-card:nth-child(7) { animation-delay: .62s; }
            .insight-card:nth-child(8) { animation-delay: .67s; }
            ...
            .table-card  { animation: fadeSlideUp .5s .40s ease both; }

            #promotionsTableBody tr { animation: rowSlideIn .35s ease both; }
            #promotionsTableBody tr:nth-child(1)  { animation-delay: .42s; }
            #promotionsTableBody tr:nth-child(2)  { animation-delay: .47s; }
            #promotionsTableBody tr:nth-child(3)  { animation-delay: .52s; }
            #promotionsTableBody tr:nth-child(4)  { animation-delay: .57s; }
            #promotionsTableBody tr:nth-child(5)  { animation-delay: .62s; }
            #promotionsTableBody tr:nth-child(6)  { animation-delay: .67s; }
            #promotionsTableBody tr:nth-child(7)  { animation-delay: .72s; }
            #promotionsTableBody tr:nth-child(8)  { animation-delay: .77s; }
            #promotionsTableBody tr:nth-child(9)  { animation-delay: .82s; }
            #promotionsTableBody tr:nth-child(10) { animation-delay: .87s; }
        ...
        <div class="space-y-4">
            ...
            <div class="filter-card bg-white dark:bg-gray-800
                ...
                <form method="GET" action="{{ route('reports.promotions') }}" class="p-4 sm:p-5">
                    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-3">
                        ...
                        {{-- Promo Type --}}
                        <div>
                            <label class="block text-[10px] font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-1.5">Promo Type</label>
                        ...
                        {{-- Status --}}
                        <div>
                            <label class="block text-[10px] font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-1.5">Status</label>
                        ...
                        <div>
                            ...
                            <select name="sort" class="filter-select">
                                ...
                                <option value="highest_discount" @selected(request('sort') == 'highest_discount')>Highest Discount</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex gap-1.5">
                                <input type="date" name="start_date" value="{{ request('start_date') }}" class="filter-select" placeholder="From">
                                <input type="date" name="end_date"   value="{{ request('end_date') }}"   class="filter-select" placeholder="To">
                            </div>
                        </div>
                            ...
                            <div class="flex gap-2">
                                <div class="relative flex-1">
                                    ...
                                    <input type="text" name="keyword" value="{{ request('keyword') }}"
                                           placeholder="Promotion title, description…"
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-3">
                ...
                <div class="chart-card bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl overflow-hidden">
                    ...
                    <div class="p-4 sm:p-5"><div class="h-64"><canvas id="promotionTrendChart"></canvas></div></div>
                </div>
                ...
                <div class="chart-card bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl overflow-hidden">
                    ...
                    <div class="p-4 sm:p-5"><div class="h-64"><canvas id="promotionStatusChart"></canvas></div></div>
                </div>

                {{-- Types Horizontal Bar --}}
                <div class="chart-card bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl overflow-hidden">
                    <div class="px-4 sm:px-5 py-3.5 border-b border-gray-100 dark:border-gray-700 flex items-center gap-2">
                        <div class="w-6 h-6 rounded-lg bg-gradient-to-br from-purple-500 to-violet-600 flex items-center justify-center">
                            <svg class="w-3 h-3 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <div class="p-4 sm:p-5"><div class="h-64"><canvas id="promotionTypeChart"></canvas></div></div>
                </div>

                {{-- Top Discounts Bar --}}
                <div class="chart-card bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl overflow-hidden">
                    <div class="px-4 sm:px-5 py-3.5 border-b border-gray-100 dark:border-gray-700 flex items-center gap-2">
                        <div class="w-6 h-6 rounded-lg bg-gradient-to-br from-orange-500 to-amber-600 flex items-center justify-center">
                            <svg class="w-3 h-3 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <div class="p-4 sm:p-5"><div class="h-64"><canvas id="promotionDiscountChart"></canvas></div></div>
                </div>
            ...
            <div class="table-card bg-white dark:bg-gray-800
                        ...
                        <tbody id="promotionsTableBody" class="divide-y divide-gray-100 dark:divide-gray-700">
                            @forelse($promotions as $promotion)
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/20 transition-colors duration-150">
                                    ...
                                    {{-- Status --}}
                                    <td class="px-6 py-4 text-center">
                                        <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-[11px] font-semibold {{ $statusBg }} {{ $statusText }}">
                                ...
                                <tr>
                                    <td colspan="7" class="px-6 py-16 text-center">
                                        <div class="flex flex-col items-center gap-3">
                                            ...
                                            <p class="text-sm text-gray-400 dark:text-gray-500">No promotions found. Try adjusting your filters.</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
                ...
                <div class="px-6 py-4 border-t border-gray-100 dark:border-gray-700
                    ...
                    <p class="text-xs text-gray-400 dark:text-gray-500">
                        @if($promotions->total())
                            Showing
                            <span class="font-semibold text-gray-700 dark:text-gray-200">{{ $promotions->firstItem() }}–{{ $promotions->lastItem() }}</span>
                            of
                            <span class="font-semibold text-gray-700 dark:text-gray-200">{{ number_format($promotions->total()) }}</span>
                            results
                        @else
                            No records found
                        @endif
        ...
        <div id="exportModal"
            ...
            <div class="modal-inner bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700
                ...
                <div class="p-6 space-y-3">
                    ...
                    <a href="{{ route('reports.promotions.export.csv') }}"
                    ...
                    <a href="{{ route('reports.promotions.export.pdf') }}"
                       class="group flex items-center justify-between px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-600
            ...
            <script defer>
                ...
                window.addEventListener('load', () => {
                    ...
                    new Chart(document.getElementById('promotionDiscountChart'), {
                        type: 'bar',
                        data: {
                            labels: @json($topDiscountChart->pluck('title')),
                            datasets: [{
                                label: 'Discount %',
