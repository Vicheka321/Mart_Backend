                        ...
                        @forelse($products as $product)
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/20 transition-colors duration-150">
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <div class="flex items-center gap-2 mt-0.5">
                                                <span class="text-[10px] text-gray-400 dark:text-gray-500">⭐ {{ $product->rating ?? '—' }}</span>
                                                <span class="text-[10px] text-gray-400 dark:text-gray-500">❤️ {{ number_format($product->favorites ?? 0) }}</span>
                                                <span class="text-[10px] text-gray-400 dark:text-gray-500">👁 {{ number_format($product->views ?? 0) }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 text-right">
                                    ...
                                    <span class="text-sm font-semibold {{ $margin >= 30 ? 'text-emerald-600 dark:text-emerald-400' : ($margin >= 10 ? 'text-amber-600 dark:text-amber-400' : 'text-rose-600 dark:text-rose-400') }}">
                                        {{ $margin }}%
                                    </span>
                                </td>
