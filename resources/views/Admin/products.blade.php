...
@section('content')
    ...
    <div class="space-y-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
            ...
            {{-- Inactive Products --}}
            @php
                $inactivePct = $totalProducts > 0
                    ? round(($totalInactive / $totalProducts) * 100)
                    : 0;
            @endphp
            ...
            <a href="{{ route('products.index', ['status' => 'inactive']) }}"
             class="stat-card relative overflow-hidden rounded-2xl bg-white dark:bg-gray-800
                ...
                <div class="absolute -top-12 -right-10 w-32 h-32 rounded-full
                            ...
                            dark:from-red-900/20 dark:to-rose-900/20"></div>
                ...
                <div class="relative pl-1">
                    ...
                    <h2
                        class="stat-number text-2xl font-bold tracking-tight leading-none
                            bg-gradient-to-r from-red-600 to-rose-600
                            bg-clip-text text-transparent"
                        data-count="{{ $totalInactive }}">
                ...
                <div class="relative">
                    ...
                    <div class="mt-1 flex items-center justify-between">
                        ...
                        <span class="text-[10px] font-semibold text-red-600 dark:text-red-400">
                            ...
                            {{ number_format($totalInactive) }} inactive
            ...
            <a href="{{ route('products.index', ['status' => 'low-stock']) }}"
             class="stat-card relative overflow-hidden rounded-2xl bg-white dark:bg-gray-800
                        border border-gray-100 dark:border-gray-700
                        shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 p-4 flex flex-col gap-2">
                <div class="absolute -top-12 -right-10 w-32 h-32 rounded-full
        ...
        <div class="table-card bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl overflow-hidden">
            ...
            <div id="gridViewWrap" class="p-3 sm:p-5">
                <div id="productsTable"
                     class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-5 gap-3 sm:gap-4">
