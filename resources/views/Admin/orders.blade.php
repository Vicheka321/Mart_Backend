...
@section('content')
    ...
    <style>
        ...
        #ordersTableBody tr:nth-child(1) {
            animation-delay: .35s;
        }

        #ordersTableBody tr:nth-child(2) {
            animation-delay: .40s;
        }

        #ordersTableBody tr:nth-child(3) {
            animation-delay: .45s;
        }

        #ordersTableBody tr:nth-child(4) {
            animation-delay: .50s;
        }

        #ordersTableBody tr:nth-child(5) {
            animation-delay: .55s;
        }

        #ordersTableBody tr:nth-child(6) {
            animation-delay: .60s;
        }

        #ordersTableBody tr:nth-child(7) {
            animation-delay: .65s;
        }

        #ordersTableBody tr:nth-child(8) {
            animation-delay: .70s;
        }

        #ordersTableBody tr:nth-child(9) {
            animation-delay: .75s;
        }

        #ordersTableBody tr:nth-child(10) {
            animation-delay: .80s;
        }
    ...
    <div class="space-y-4" x-data="{ view: 'list' }">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
            ...
            {{-- Total Orders --}}
            <a href="{{ route('orders.index', ['status' => 'all']) }}" class="stat-card relative overflow-hidden rounded-2xl bg-white dark:bg-gray-800
                ...
                <div class="relative mt-2">
                    <div class="h-1.5 rounded-full bg-gray-100 dark:bg-gray-700 overflow-hidden">
                        <div
                            class="progress-bar h-full w-full rounded-full bg-gradient-to-r from-pink-500 via-rose-500 to-fuchsia-600">
                        </div>
                    </div>
            ...
            <a href="{{ route('orders.index', ['status' => 'pending']) }}" class="stat-card relative overflow-hidden rounded-2xl bg-white dark:bg-gray-800
                            border border-gray-100 dark:border-gray-700
                            shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 p-3">
                <div
                    class="absolute -top-8 -right-8 w-24 h-24 rounded-full bg-gradient-to-br from-amber-50 to-yellow-100 dark:from-amber-900/20 dark:to-yellow-900/20">
                </div>
                <div class="relative flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        <div
                            class="w-7 h-7 rounded-xl bg-gradient-to-br from-amber-500 to-yellow-600 flex items-center justify-center shadow-md shadow-amber-500/25">
                    ...
                    <span
                        class="inline-flex items-center px-1.5 py-0.5 rounded-full bg-amber-50 dark:bg-amber-900/20 text-amber-600 dark:text-amber-400 ring-1 ring-amber-200 dark:ring-amber-800 text-[10px] font-semibold">{{ $pendingPct }}%</span>
                </div>
                <div class="relative mt-2 pl-2">
                ...
                <div class="relative mt-2">
                    <div class="h-1.5 rounded-full bg-gray-100 dark:bg-gray-700 overflow-hidden">
                        <div class="progress-bar h-full rounded-full bg-gradient-to-r from-amber-500 to-yellow-600"
                            style="width: {{ $pendingPct }}%"></div>
                    </div>
                    <div class="mt-1 flex items-center justify-between">
                        <span class="text-[10px] text-gray-400 dark:text-gray-500">{{ $pendingPct }}% of total</span>
                        <span
                            class="text-[10px] font-semibold text-amber-600 dark:text-amber-400">{{ number_format($totalOrders ?? 0) }}
                            total</span>
                    </div>
                </div>
            </a>
            ...
            <a href="{{ route('orders.index', ['status' => 'processing']) }}" class="stat-card relative overflow-hidden rounded-2xl bg-white dark:bg-gray-800
                            border border-gray-100 dark:border-gray-700
                            shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 p-3">
                <div
                    class="absolute -top-8 -right-8 w-24 h-24 rounded-full bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-blue-900/20 dark:to-indigo-900/20">
                </div>
                <div class="relative flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        <div
                            class="w-7 h-7 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center shadow-md shadow-blue-500/25">
                            <svg class="w-3.5 h-3.5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                stroke-width="2">
                    ...
                    <span
                        class="inline-flex items-center px-1.5 py-0.5 rounded-full bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 ring-1 ring-blue-200 dark:ring-blue-800 text-[10px] font-semibold">{{ $processingPct }}%</span>
                </div>
                <div class="relative mt-2 pl-2">
                ...
                <div class="relative mt-2">
                    <div class="h-1.5 rounded-full bg-gray-100 dark:bg-gray-700 overflow-hidden">
                        <div class="progress-bar h-full rounded-full bg-gradient-to-r from-blue-500 to-indigo-600"
                            style="width: {{ $processingPct }}%"></div>
                    </div>
                    <div class="mt-1 flex items-center justify-between">
                        <span class="text-[10px] text-gray-400 dark:text-gray-500">{{ $processingPct }}% of total</span>
                        <span
                            class="text-[10px] font-semibold text-blue-600 dark:text-blue-400">{{ number_format($totalOrders ?? 0) }}
                            total</span>
                    </div>
                </div>
            </a>
            ...
            <a href="{{ route('orders.index', ['status' => 'completed']) }}" class="stat-card relative overflow-hidden rounded-2xl bg-white dark:bg-gray-800
                            border border-gray-100 dark:border-gray-700
                            shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 p-3">
                <div
                ...
                <div class="relative flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        <div
                            class="w-7 h-7 rounded-xl bg-gradient-to-br from-emerald-500 to-green-600 flex items-center justify-center shadow-md shadow-emerald-500/25">
                            <svg class="w-3.5 h-3.5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" />
                            </svg>
                    ...
                    <span
                        class="inline-flex items-center px-1.5 py-0.5 rounded-full bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400 ring-1 ring-emerald-200 dark:ring-emerald-800 text-[10px] font-semibold">{{ $completedPct }}%</span>
                </div>
                <div class="relative mt-2 pl-2">
                ...
                <div class="relative mt-2">
                    ...
                    <div class="mt-1 flex items-center justify-between">
                        ...
                        <span
                            class="text-[10px] font-semibold text-emerald-600 dark:text-emerald-400">{{ number_format($totalOrders ?? 0) }}
                            total</span>
                    </div>
                </div>
            </a>
            ...
            <a href="{{ route('orders.index', ['status' => 'cancelled']) }}" class="stat-card relative overflow-hidden rounded-2xl bg-white dark:bg-gray-800
                            border border-gray-100 dark:border-gray-700
                            shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 p-3">
                <div
                    class="absolute -top-8 -right-8 w-24 h-24 rounded-full bg-gradient-to-br from-red-50 to-rose-100 dark:from-red-900/20 dark:to-rose-900/20">
                </div>
                <div class="relative flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        <div
                            class="w-7 h-7 rounded-xl bg-gradient-to-br from-red-500 to-rose-600 flex items-center justify-center shadow-md shadow-red-500/25">
                            <svg class="w-3.5 h-3.5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                stroke-width="2">
                    ...
                    <span
                        class="inline-flex items-center px-1.5 py-0.5 rounded-full bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 ring-1 ring-red-200 dark:ring-red-800 text-[10px] font-semibold">{{ $cancelledPct }}%</span>
                </div>
                <div class="relative mt-2 pl-2">
                ...
                <div class="relative mt-2">
                    <div class="h-1.5 rounded-full bg-gray-100 dark:bg-gray-700 overflow-hidden">
                        <div class="progress-bar h-full rounded-full bg-gradient-to-r from-red-500 to-rose-600"
                            style="width: {{ $cancelledPct }}%"></div>
                    </div>
                    <div class="mt-1 flex items-center justify-between">
                        <span class="text-[10px] text-gray-400 dark:text-gray-500">{{ $cancelledPct }}% of total</span>
                        <span
                            class="text-[10px] font-semibold text-red-600 dark:text-red-400">{{ number_format($totalOrders ?? 0) }}
                            total</span>
                    </div>
                </div>
            </a>
        ...
        <div
            ...
            {{-- CARD HEADER --}}
            <div
                class="p-4 sm:p-5 border-b border-gray-100 dark:border-gray-700 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3">
                ...
                <div class="flex items-center gap-2 flex-wrap">
                    ...
                    <div class="inline-flex items-center rounded-xl border border-gray-200 dark:border-gray-600
                        ...
                        <button type="button" @click="view = 'grid'"
                            ...
                            class="view-toggle-btn w-8 h-8 flex items-center justify-center rounded-lg" title="Grid view">
                        ...
                        <button type="button" @click="view = 'list'"
                            ...
                            class="view-toggle-btn w-8 h-8 flex items-center justify-center rounded-lg" title="List view">
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            @if($current !== 'all')
                <div class="px-4 sm:px-5 py-2.5 bg-indigo-50 dark:bg-indigo-500/10 border-b border-indigo-100 dark:border-indigo-500/20
                    ...
                    <a href="?status=all"
                        class="text-xs text-indigo-500 dark:text-indigo-400 hover:underline self-start sm:self-auto">Clear
                        filter</a>
                </div>
            @endif
            ...
            <div x-show="view === 'list'" x-cloak>
                                ...
                                <tr id="order-row-{{ $order['id'] }}" data-order-id="{{ $order['id'] }}"
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            ...
                                            @else
                                                <div
                                                    class="w-8 h-8 rounded-full bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300
                                    ...
                                    {{-- PHONE --}}
                                    <td
                                        class="px-6 py-4 text-gray-500 dark:text-gray-400 whitespace-nowrap hidden lg:table-cell">
                                        {{ $order['phone'] ?? '—' }}
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap hidden lg:table-cell">
                                        ...
                                        @endphp
                                        <span
                                            class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-semibold {{ $styles }}">
                                    ...
                                    {{-- DATE --}}
                                    <td
                                        class="px-6 py-4 text-gray-500 dark:text-gray-400 whitespace-nowrap text-xs hidden xl:table-cell">
                                        {{ $order['created_at'] }}
                                    </td>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex justify-end items-center gap-2" id="actions-{{ $order['id'] }}">
                                            ...
                                            @if($order['status'] === 'processing')
                                                <button onclick="printInvoice({{ $order['id'] }})" class="action-btn inline-flex items-center gap-1 px-3 py-1.5 text-xs font-medium rounded-lg
                ...
                <div class="md:hidden divide-y divide-gray-100 dark:divide-gray-700">
                    @forelse($orders as $order)
                        ...
                        <div id="order-row-mobile-{{ $order['id'] }}" data-order-id="{{ $order['id'] }}"
                            data-status="{{ $order['status'] }}" class="p-4 flex flex-col gap-3">
                            <div class="flex items-start justify-between gap-2">
                                <div class="flex items-center gap-3 min-w-0">
                                    ...
                                    @else
                                        <div
                                            class="w-9 h-9 rounded-full bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300
                                                                flex items-center justify-center text-xs font-semibold flex-shrink-0">
                                            {{ $initialsM ?: strtoupper(substr($fullNameM, 0, 1)) }}
                                        </div>
                                    @endif
                                    <div class="min-w-0">
                                        <p class="font-medium text-sm text-gray-900 dark:text-white truncate">{{ $fullNameM }}
                                        </p>
                                        <p class="text-[11px] text-gray-400 dark:text-gray-500">{{ $order['phone'] ?? '—' }}</p>
                                    </div>
                                </div>
                                <span
                                    class="status-badge flex-shrink-0 inline-flex items-center px-3 py-1 rounded-full text-xs font-medium {{ $badgeM }}">
                                    {{ ucfirst($order['status']) }}
                                </span>
                            </div>
                            ...
                            <div class="flex items-center gap-2 pt-1">
                                <button type="button" onclick='openOrderModal(@json($order))' class="action-btn flex-1 inline-flex items-center justify-center gap-1.5 h-9 rounded-lg text-xs font-medium
                                                   border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700
                                ...
                                @if($order['status'] === 'pending')
                                    <button type="button" class="accept-btn action-btn flex-1 inline-flex items-center justify-center h-9 rounded-lg text-xs font-medium
                                                           border border-blue-200 dark:border-blue-500/30 bg-blue-50 dark:bg-blue-500/10
                                ...
                                @if(in_array($order['status'], ['processing', 'completed']))
                                    <button type="button" onclick="printInvoice({{ $order['id'] }})" class="action-btn w-9 h-9 flex-shrink-0 inline-flex items-center justify-center rounded-lg
                        ...
                        <button type="button" onclick='openOrderModal(@json($order))'
                            ...
                            <div class="flex items-start justify-between gap-2">
                                <div class="flex items-center gap-2.5 min-w-0">
                                    ...
                                    @endif
                                    <div class="min-w-0">
                                        <p class="text-sm font-semibold text-gray-900 dark:text-white truncate">{{ $fullNameG }}
                                        </p>
                                        <p class="text-[11px] text-gray-400 dark:text-gray-500 truncate">#{{ $order['id'] }} ·
                                            {{ $order['phone'] ?? '—' }}</p>
                                    </div>
                                </div>
                                <span
                                    class="status-badge flex-shrink-0 inline-flex items-center px-2.5 py-1 rounded-full text-[11px] font-medium {{ $badgeG }}">
                                    {{ ucfirst($order['status']) }}
                                </span>
                            </div>
                            ...
                            <div class="flex items-center justify-between">
                                <span
                                    class="text-lg font-bold text-gray-900 dark:text-white">${{ number_format($order['total'], 2) }}</span>
                                <span class="text-[11px] text-gray-400 dark:text-gray-500">{{ $order['created_at'] }}</span>
                            </div>

                            <div
                                class="flex items-center gap-1.5 pt-1 border-t border-gray-100 dark:border-gray-700 text-[11px]">
                                <span
                                    class="text-gray-400 dark:text-gray-500">{{ strtoupper($order['payment_method'] ?? 'N/A') }}</span>
                                <span class="text-gray-300 dark:text-gray-600">·</span>
                                <span
                                    class="text-gray-400 dark:text-gray-500">{{ ucfirst($order['payment_status'] ?? '—') }}</span>
            ...
            <div class="px-4 sm:px-6 py-4 border-t border-gray-100 dark:border-gray-700
                ...
                <p class="text-xs text-gray-400 dark:text-gray-500">
                    @if($orders->total())
                        ...
                        of
                        <span
                            class="font-semibold text-gray-700 dark:text-gray-200">{{ number_format($orders->total()) }}</span>
                        results
                    @else
                        No orders found
                    @endif
                ...
                @if($orders->hasPages())
                    ...
                    <nav class="flex items-center gap-1 overflow-x-auto">
                        ...
                        @if($orders->onFirstPage())
                            <span
                                class="w-8 h-8 flex items-center justify-center rounded-lg text-gray-300 dark:text-gray-600 cursor-not-allowed flex-shrink-0">
                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7" />
                                </svg>
                            </span>
                        @else
                            <a href="{{ $orders->previousPageUrl() }}" class="w-8 h-8 flex items-center justify-center rounded-lg text-gray-500 dark:text-gray-400
                        ...
                        @if($start > 1)
                            <a href="{{ $orders->url(1) }}" class="min-w-[32px] h-8 px-2 inline-flex items-center justify-center rounded-lg
                            ...
                            @if($start > 2)
                                <span
                                    class="w-8 h-8 flex items-center justify-center text-sm text-gray-300 dark:text-gray-600 select-none flex-shrink-0">…</span>
                            @endif
                        @endif
                        ...
                        @if($end < $last)
                            @if($end < $last - 1)
                                <span
                                    class="w-8 h-8 flex items-center justify-center text-sm text-gray-300 dark:text-gray-600 select-none flex-shrink-0">…</span>
                            @endif
                            <a href="{{ $orders->url($last) }}" class="min-w-[32px] h-8 px-2 inline-flex items-center justify-center rounded-lg
                                                  text-sm font-medium text-gray-500 dark:text-gray-400
                                                  hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white
                                                  transition-colors duration-150 flex-shrink-0">
                                {{ $last }}
                        ...
                        @if($orders->hasMorePages())
                            <a href="{{ $orders->nextPageUrl() }}" class="w-8 h-8 flex items-center justify-center rounded-lg text-gray-500 dark:text-gray-400
                                                hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white
                                                transition-colors duration-150 flex-shrink-0">
                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <div id="exportModal"
        ...
        <div class="modal-inner bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700
            ...
            <div
                class="flex items-center justify-between p-4 sm:p-6 border-b border-gray-100 dark:border-gray-700 flex-shrink-0">
                <div class="flex items-center gap-3">
            ...
            <div class="flex-1 overflow-y-auto p-4 sm:p-6 space-y-3">
                ...
                <a href="{{ route('orders.export.csv') }}" class="group flex items-center justify-between px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-600
                    ...
                    <div class="flex items-center gap-3">
                        <div
                            class="w-8 h-8 rounded-lg bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 group-hover:border-emerald-300 flex items-center justify-center transition-all">
                ...
                <a href="{{ route('orders.export.pdf') }}" class="group flex items-center justify-between px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-600
                    ...
                    <div class="flex items-center gap-3">
                        <div
                            class="w-8 h-8 rounded-lg bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 group-hover:border-red-300 flex items-center justify-center transition-all">
            ...
            <div class="px-4 sm:px-6 pb-4 sm:pb-6 flex-shrink-0">
                <button onclick="closeExportModal()"
                    class="w-full py-2 text-sm font-medium rounded-xl border border-gray-200 dark:border-gray-600 text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 transition">Cancel</button>
            </div>
        </div>
    </div>
        ...
        <div
            ...
            <div class="bg-indigo-700 px-4 sm:px-6 pt-6 pb-12 flex-shrink-0">
                <div class="flex items-start justify-between">
                    <div>
                        <p id="modalOrderId" class="text-[11px] font-medium tracking-widest text-indigo-300 uppercase mb-1">
                            Order #—</p>
