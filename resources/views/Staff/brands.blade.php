                            ...
                            <td class="px-5 py-0.5">
                                @if ($brand->image)
                                            <div class="relative group w-10 h-10">
                                                ...
                                                <!-- small image -->
                                                <img src="{{ asset($brand->image) }}" class="w-10 h-10 rounded-lg object-cover border border-gray-100 dark:border-gray-600 
                                    transition duration-300 ease-in-out 
                                    group-hover:scale-125 group-hover:z-50 relative">

                                                <!-- preview big -->
                                                <div class="absolute hidden group-hover:block z-50 left-12 top-0">
                                                    <img src="{{ asset($brand->image) }}"
                                                        class="w-32 h-32 object-cover rounded-xl shadow-xl border bg-white">
                                                </div>

                                            </div>
                                @else
                                    <div
                                        class="w-10 h-10 rounded-lg bg-gray-100 dark:bg-gray-700 flex items-center justify-center text-gray-400 font-semibold text-sm">
        ...
        <div class="mt-4 flex items-center justify-between text-gray-500 dark:text-gray-400">
            ...
            <div class="flex space-x-1">
                ...
                @if ($brands->onFirstPage())
                    <span
                        class="px-3 py-1 rounded-lg 
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            text-sm">Prev</span>
                @else
                    <a href="{{ $brands->previousPageUrl() }}" wire:navigate
                        class="px-3 py-1 rounded-lg 
                                                                                                                                                                                                        bg-white dark:bg-slate-800 
                                                                                                                                                                                                        border border-gray-200 dark:border-gray-700 
                ...
                @if ($brands->hasMorePages())
                    <a href="{{ $brands->nextPageUrl() }}" wire:navigate
                        class="px-3 py-1 rounded-lg 
                                                                                                                                                                                                                                                                                                            bg-white dark:bg-slate-800 
                                                                                                                                                                                                                                                                                                            border border-gray-200 dark:border-gray-700 
                                                                                                                                                                                                                                                                                                            hover:bg-indigo-50 dark:hover:bg-indigo-500/10 
                ...
                <form id="brandForm" action="{{ route('brands.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex gap-4 mb-4">
                        ...
                        <div class="w-1/2">
                            ...
                            <input type="text" name="name" id="brandName" placeholder="e.g. Nike"
                                class="w-full px-4 py-2.5 border border-gray-200 dark:border-gray-600 rounded-xl text-sm 
